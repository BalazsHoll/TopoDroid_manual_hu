...
import com.topodroidhb.prefs.TDPrefHelper;
import com.topodroidhb.prefs.TDSetting;
import com.topodroidhb.packetX.MemoryOctet;
import com.topodroidhb.dev.Device;
// import com.topodroid.dev.ConnectionState;
import com.topodroidhb.dev.TopoDroidComm;
import com.topodroidhb.dev.DataType;
import com.topodroidhb.dev.distox1.DistoXA3Comm;
import com.topodroidhb.dev.distox1.DeviceA3Info;
import com.topodroidhb.dev.distox2.DistoX310Comm;
import com.topodroidhb.dev.distox2.DeviceX310Info;
import com.topodroidhb.dev.distox2.DeviceX310Details;
import com.topodroidhb.dev.sap.SapComm;
import com.topodroidhb.dev.bric.BricComm;
import com.topodroidhb.dev.bric.BricInfoDialog;
import com.topodroidhb.dev.PairingRequest;
...
import com.topodroidhb.calib.CalibInfo;
import com.topodroidhb.calib.CalibExport;
...
public class TopoDroidApp extends Application
{
  ...
  */
  ...
  /** @return the density of the display, e.g, 286.197
   */
  public static float getDisplayDensityX( ) // HBX
  {
    return Resources.getSystem().getDisplayMetrics().xdpi;
  }
  /** @return the density of the display, e.g, 286.449
   */
  public static float getDisplayDensityY( ) // HBX
  {
    return Resources.getSystem().getDisplayMetrics().ydpi;
  }
  /** @return the density of the display, e.g, 286.449
   */
  public static float getDisplayDensityXY( ) // HBX
  {
    return (Resources.getSystem().getDisplayMetrics().ydpi+Resources.getSystem().getDisplayMetrics().ydpi)/2.0f;
  }
  ...
  public static int getDisplayDensityDpi( )
  {
    ...
    //return (int) Resources.getSystem().getDisplayMetrics().xdpi; // HBX
  }
