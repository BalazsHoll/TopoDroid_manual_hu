...
class DrawingScaleReference
{
  ...
  private static final int HBartp = 3; // HBX_artp
  ...
  void draw( Canvas canvas, float zoom, boolean landscape, float locx, float locy, float sketch_unit )
  {
	...
	if ( landscape ) {
	  float x = locX + arrowlen;
          ...
          canvas.drawLine( x-arrowlen+arrowtip, y-(arrowtip/HBartp), x - arrowlen, y, mPaint); // HBX_artp
          canvas.drawLine( x-arrowlen+arrowtip, y+(arrowtip/HBartp), x - arrowlen, y, mPaint);// HBX_artp
          if ( mHasDecl ) {
          ...
          canvas.drawLine( x-(arrowtip/HBartp), y-arrowlen+arrowtip, x, y - arrowlen, mPaint); // HBX_artp
          canvas.drawLine( x+(arrowtip/HBartp), y-arrowlen+arrowtip, x, y - arrowlen, mPaint); // HBX_artp
          if ( mHasDecl ) {
  ...
  void draw( Canvas canvas, float zoom, boolean landscape, float locx, float locy, float sketch_unit, int xor_color )
  {
	...
	if ( landscape ) {
	  float x = locX + arrowlen;
          ...
          canvas.drawLine( x-arrowlen+arrowtip, y-(arrowtip/HBartp), x - arrowlen, y, paint); // HBX_artp
          canvas.drawLine( x-arrowlen+arrowtip, y+(arrowtip/HBartp), x - arrowlen, y, paint); // HBX_artp
          if ( mHasDecl ) {
          ...
          canvas.drawLine( x-(arrowtip/HBartp), y-arrowlen+arrowtip, x, y - arrowlen, paint); // HBX_artp
          canvas.drawLine( x+(arrowtip/HBartp), y-arrowlen+arrowtip, x, y - arrowlen, paint); // HBX_artp
          if ( mHasDecl ) {
            float xd = x - arrowlen * mSdecl;
            float yd = y - arrowlen * mCdecl;
