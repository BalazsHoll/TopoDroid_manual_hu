...
import com.topodroidhb.utils.TDColor; // HBXmm
    ...
    synchronized( TDPath.mGridsLock ) {
      if( grids && mGridStack1 != null ) {
        ...
        if ( isFixedZoom() ) {
          ...
          int j = - (int)( mOffy / step ); // HBXmm
          float y = mOffy +  j * step ; // HBXmm
          Paint fixedGridStepyPaint = BrushManager.makePaintmm( TDColor.DARK_GRID,  0, Paint.Style.STROKE, step, -x); // HBXmm
          Paint fixedGridStepxPaint = BrushManager.makePaintmm( TDColor.DARK_GRID,  0, Paint.Style.STROKE, step, -y); // HBXmm
          ...
          for ( ; x<TopoDroidApp.mDisplayWidth; x += step ) {
            ...
            if ( i % 10 == 0 ) { 
              ...
              //HBXmm dpath.setPathPaint( paint_grid );
              dpath.setPathPaint( fixedGridStepxPaint ); // HBXmm
            }
            ++i;
          ...
          //HBXmm int j = - (int)( mOffy / step );
          //HBXmm float y = mOffy + j * step;
          for ( ; y<TopoDroidApp.mDisplayHeight; y += step ) {
            ...
            if ( j % 10 == 0 ) { 
              ...
              //HBXmm dpath.setPathPaint( paint_grid );
              dpath.setPathPaint( fixedGridStepyPaint ); // HBXmm
            }
            ++j;
            dpath.mPath  = new Path();
