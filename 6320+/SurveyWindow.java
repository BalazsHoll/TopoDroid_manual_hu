...
import com.topodroidhb.common.ExportInfo;
...
import com.topodroidhb.calib.CalibCheckDialog;
    ...
    // if ( TopoDroidApp.exportSurveyAsThSync( ) ) { // make sure to have survey exported as therion
      ...
      // } else if ( check == 0 ) {
        try {
          ...
          Intent intent = new Intent( Intent.ACTION_VIEW ).setClass( this, com.topodroidhb.TDX.TopoGL.class );
  ...
  */
  ...
  private void handleMenu( int pos )
  {
    ...
    if ( p++ == pos ) { // CLOSE
      ...
      //HBX List< DBlock > shots = mApp_mData.selectAllShots( TDInstance.sid, TDStatus.CHECK );
      List< DBlock > shots = mApp_mData.selectAllShots2( TDInstance.sid, TDStatus.CHECK ); // HBX
