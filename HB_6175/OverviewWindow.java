...
//75
      ...
      TDLog.v( "HBE rect " + bnds.right + " " + bnds.left + " == " + bnds.bottom + " " + bnds.top );
       // HBE rect 241.52078 -30.262375 == 204.04204 -1.0
      ...
      manager.executeAll( page.getCanvas(), -1.0f, null, true ); // zoom is 1.0, false = no inverted_color // HBX
