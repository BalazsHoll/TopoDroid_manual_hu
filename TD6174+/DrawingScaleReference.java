  ...
  void draw( Canvas canvas, float zoom, boolean landscape, float locx, float locy, float sketch_unit )
  {
	...
	if ( landscape ) {
	  float x = locX + arrowlen;
          ...
          canvas.drawLine( x-arrowlen+arrowtip, y-(arrowtip/3), x - arrowlen, y, mPaint);  // HBX
          canvas.drawLine( x-arrowlen+arrowtip, y+(arrowtip/3), x - arrowlen, y, mPaint);  // HBX
          ...
          canvas.drawLine( x-(arrowtip/3), y-arrowlen+arrowtip, x, y - arrowlen, mPaint);  // HBX
          canvas.drawLine( x+(arrowtip/3), y-arrowlen+arrowtip, x, y - arrowlen, mPaint);  // HBX
          // if ( mExtendAzimuth && TDAzimuth.mFixedExtend == 0 ) {
  ...
  void draw( Canvas canvas, float zoom, boolean landscape, float locx, float locy, float sketch_unit, int xor_color )
  {
	...
	if ( landscape ) {
	  float x = locX + arrowlen;
          ...
          canvas.drawLine( x-arrowlen+arrowtip, y-(arrowtip/3), x - arrowlen, y, paint);  // HBX
          canvas.drawLine( x-arrowlen+arrowtip, y+(arrowtip/3), x - arrowlen, y, paint);  // HBX
          // if ( mExtendAzimuth && TDAzimuth.mFixedExtend == 0 ) {
          ...
          canvas.drawLine( x-(arrowtip/3), y-arrowlen+arrowtip, x, y - arrowlen, paint);  // HBX
          canvas.drawLine( x+(arrowtip/3), y-arrowlen+arrowtip, x, y - arrowlen, paint);  // HBX
          // if ( mExtendAzimuth && TDAzimuth.mFixedExtend == 0 ) {
