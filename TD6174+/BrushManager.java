...
public class BrushManager
{
  ...
  */
  ...
  public static final Paint fixedGrid0Paint = makePaintmm( TDColor.DARK_GRID,  0, Paint.Style.STROKE, 6,3); // HBX
   ...
   * @param width   paint stroke width
   * @param style   paint type (STROKE, FILL, or FILL_AND_STROKE)
   * @param dit     paint type
   * @param phase   paint type
   * @return the paint
   * @note used by TdmViewCommand
   */
  static Paint makePaintmm( int color, int width, Paint.Style style, float dit , float phase) // HBX
  {
    Paint paint = new Paint();
    paint.setDither(true);
    paint.setColor( color );
