...
import com.topodroidhb.io.dxf.DxfColor;
...
import com.topodroidhb.io.dxf.SymbolPointDxf;
...
public class SymbolPoint extends Symbol
{
  ...
  private void makePointPath( String path )
  {
    ...
    if ( path == null ) {
      ...
      String pname = "P_" + getThName().replace(':', '-');
// HBX_DXF
      int color2 = DxfColor.rgbToIndex(getColor());
      String layer2;
      int color;
...
// HBX_DXF
      mDxf.line( layer2, 0, 0, 1, 0, color2 );// HBX_DXF
...
// HBX_DXF
            mDxf.line(layer2, x00, -y00, x01, -y01, color2 );// HBX_DXF
...
// HBX_DXF
           mDxf.polyline( layer2, xx, yy , color2);// HBX_DXF
...
// HBX_DXF
            mDxf.circle( layer2, x0*dxfScale, -y0*dxfScale, x1*dxfScale, color2 );// HBX_DXF
...
// HBX_DXF
            mDxf.arc( layer2, (x0+x1)/2*dxfScale, -(y0+y1)/2*dxfScale, x1*dxfScale, x2, y2, color2 );// HBX_DXF
