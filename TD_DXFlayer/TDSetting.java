...
import com.topodroidhb.help.UserManDownload;
import com.topodroidhb.TDXHB.TDLevel;
import com.topodroidhb.TDXHB.TDandroid;
// import com.topodroid.TDX.TDPath;
import com.topodroidhb.TDXHB.TDAzimuth;
import com.topodroidhb.TDXHB.TDInstance;
import com.topodroidhb.TDXHB.TopoDroidApp;
import com.topodroidhb.TDXHB.BrushManager;
import com.topodroidhb.TDXHB.DrawingWindow;
import com.topodroidhb.TDXHB.DistoXStationName;
import com.topodroidhb.TDXHB.StationPolicy;
import com.topodroidhb.TDXHB.SurveyInfo;
import com.topodroidhb.TDXHB.TDToast;
import com.topodroidhb.TDXHB.TopoGL;
import com.topodroidhb.TDXHB.GlRenderer;
import com.topodroidhb.TDXHB.GlModel;
import com.topodroidhb.TDXHB.GlNames;
import com.topodroidhb.TDXHB.TglParser;
import com.topodroidhb.TDXHB.R;
import com.topodroidhb.dev.bric.BricMode; // MODE
...
public class TDSetting
{
  ...
  public static void loadSecondaryPreferences( /* TopoDroidApp my_app, */ TDPrefHelper pref_hlp )
  {
    ...
    mSvgLabelStroke    = tryFloat( prefs,      keyExpSvg[5],      defExpSvg[5] );  // DISTOX_SVG_LABEL_STROKE
    mSvgLineStroke     = tryFloat( prefs,      keyExpSvg[6],      defExpSvg[6] );  // DISTOX_SVG_LINE_STROKE
    mSvgGridStroke     = tryFloat( prefs,      keyExpSvg[7],      defExpSvg[7] );  // DISTOX_SVG_GRID_STROKE
  ...
  private static String updatePrefDem3D( TDPrefHelper hlp, String k, String v )
  {
    ...
    if ( k.equals( key[0] ) ) { 
      ...
      TDLog.Error("missing DEM-3D key: " + k );
    }
    return ret;
  }
  ...
  private static String updatePrefWalls3D( TDPrefHelper hlp, String k, String v )
  {
    ...
    if ( k.equals( key[0] ) ) { // CAVE3D_SPLAY_USE
      ...
      TDLog.Error("missing Walls-3D key: " + k );
    }
    return ret;
  }
