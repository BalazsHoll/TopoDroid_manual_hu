...
{
  public void line( String layer, float x0, float y0, float x1, float y1, int color )// HBX_DXF
  {
    startLine( layer );
    addHandle( DXF.ACAD_12 );
    addAcDbLine( false );
    addLine( x0, y0, x1, y1, color );// HBX_DXF
  }

  public void polyline( String layer, float[] xx, float[] yy, int color )// HBX_DXF
  {
    startPolyline( /* layer */ );
    addHandle( DXF.ACAD_12 );
    ...
    addAcDbPolyline();
    addPolylineColor( color );// HBX_DXF 256 -> color
    addPolylineGroup( 1 );
  ...
  public void circle( String layer, float x, float y, float r, int color )// HBX_DXF
  {
    startCircle( layer );
    addAcDbCircle( true );
    addCircle( x, y, r, color );// HBX_DXF
  }
  ...
  public void arc( String layer, float x, float y, float r, float a1, float a2, int color )// HBX_DXF
  {
    startArc( layer );
    addAcDbCircle( true ); 
    addCircle( x, y, r, color );// HBX_DXF
  ...
  public void ellipse( String layer, float x, float y, float a, float b, float a1, float a2, int color )// HBX_DXF
  {
    // TODO
  }
   ...
   */
  private void addLine( float x0, float y0, float x1, float y1, int color )// HBX_DXF
  {
    StringWriter sw = new StringWriter();
    PrintWriter pw  = new PrintWriter( sw );
    DXF.printInt( pw, 62, color ); // color 0: by_block, 256: by_layer // HBX_DXF
   ...
   * @param r    radius
   */
  private void addCircle( float x, float y, float r, int color )// HBX_DXF
  {
    StringWriter sw = new StringWriter();
    PrintWriter pw  = new PrintWriter( sw ); // DXF writer
    DXF.printInt( pw, 62, color ); // color 0: by_block, 256: by_layer // HBX_DXF
   ...
   * @param a2 angle ...
   */
  private void addEllipse( float x0, float y0, float x1, float y1, float r, float a1, float a2, int color )// HBX_DXF
  {
    float xc = (x0+x1)/2;
    float yc = (y0+y1)/2;
    StringWriter sw = new StringWriter();
